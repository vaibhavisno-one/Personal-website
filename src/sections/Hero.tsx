...
export const HeroSection = () => {
  return (
    <div id='hero' className='py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip' >
      ...
      <HeroOrbit size={590} rotation={98} shouldOrbit orbitDuration='48s' shouldSpin spinDuration='6s'>
      ...
      <div className="container">
        <div className='flex flex-col items-center'>
          ...
          <div className='bg-gray-950 border-gray-800 px-4 py-1.4 inline-flex items-center gap-4 rounded-lg'>
